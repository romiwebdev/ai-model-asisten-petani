...
# Tampilan Web
st.set_page_config(
    page_title="TaniAI - Asisten Petani", 
    page_icon="🌱",
    layout="centered"
)
...
# Header aplikasi
st.title("🌾 TaniAI - Asisten Petani")
st.markdown("""
...
st.markdown("""
    <div style="text-align: center; color: #7f8c8d;">
        <p>© 2025 TaniAI - Asisten Virtual Pertanian | Versi 1.1</p>
        <p>Untuk pertanyaan lebih lanjut, hubungi: rominmuh230@gmail.com</p>
    </div>
""", unsafe_allow_html=True)
